...
public class GamePanel extends GamePanelValues implements Runnable {
    ...
    public GamePanel() {
        ...
        deadDisplay = new DeadDisplay(this);
...
//        gameState = gameMenu;
    ...
    public void resetGame() {
        scoreSetter.setScore(menuButton.getButton().playerName.toString(), score);
        items.clear();
        bombList.clear();
        explosionList.clear();
        monsters.clear();
        tileMng.setMapCode(0);
        tileMng = new TileMng(this, tileMng.getMapCode());
        player.setX(player.getStartX());
        player.setY(player.getStartY());
        player.setLife(player.getMaxLife());
...
//            }
            ...
            if(gameState == gamePaused && player.getLife() > 0) menuButton.gamePaused(g2);
            if(gameState == gamePaused && player.getLife() == 0) deadDisplay.renderDead(g2);
        }
        g2.dispose();
    }
