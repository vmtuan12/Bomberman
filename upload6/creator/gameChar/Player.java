...
public class Player extends Entity {
    ...
    public Player(KeyHandle key, GamePanel panel) {
        ...
        hitboxDefaultX = 8;
        hitboxDefaultY = 16;
        hitbox = new Rectangle(hitboxDefaultX, hitboxDefaultY, gPanel.getActualTileSz() - 16, gPanel.getActualTileSz() - 20);
    ...
    private void pickUpItem(int type) {
        if(type != -1) {
            if(type == 2) {
                speed = 7;
            }
